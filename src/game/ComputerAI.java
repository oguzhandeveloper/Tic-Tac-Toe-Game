    ...
    public int evaluate(int[][] board) {
        ...
        for (int row = 0; row < 3; row++) {
            if (board[row][0] == board[row][1]
                ...
                if (board[row][0] == PLAYER_TWO) {
                    return +10;
                } else if (board[row][0] == PLAYER_ONE) {
                    return -10;
                }
            }
        }
        ...
        for (int col = 0; col < 3; col++) {
            if (board[0][col] == board[1][col]
                ...
                if (board[0][col] == PLAYER_TWO) {
                    return +10;
                } else if (board[0][col] == PLAYER_ONE) {
                    return -10;
                }
            }
        }
        ...
        if (board[0][0] == board[1][1] && board[1][1] == board[2][2]) {
            if (board[0][0] == PLAYER_TWO) {
                return +10;
            } else if (board[0][0] == PLAYER_ONE) {
                return -10;
            }
        }

        if (board[0][2] == board[1][1] && board[1][1] == board[2][0]) {
            if (board[0][2] == PLAYER_TWO) {
                return +10;
            } else if (board[0][2] == PLAYER_ONE) {
                return -10;
            }
        }
